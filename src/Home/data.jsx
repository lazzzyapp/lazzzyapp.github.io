...
export const team = [
  {
    ...
    content: [
      ...
      <p key="2">Zeid originally hails from Georgia, USA but grew up splitting his time between Damascus, Syria and Michigan, USA. The idea for Lazzzy originated with Zeid, stemming from his own desire for better note-taking tools to decode and organize the overload of online academic resources. His favorite hobbies are reading and video games where he currently maintains a solid 1.3 KDA on Call of Duty. When asked how does he <i>embrace the lazzzy Zeid</i> he replied, “when I get a food coma in the middle of a meal, I take a nap to finish my food later.” </p>,
    ],
